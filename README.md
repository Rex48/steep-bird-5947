...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steep-bird-5947)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/steep-bird-5947
```

A live public deployment of this template is available at [https://steep-bird-5947.templates.workers.dev](https://steep-bird-5947.templates.workers.dev)
